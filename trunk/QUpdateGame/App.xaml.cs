...
namespace QUpdateGame
{
    ...
    public partial class App : Application
    {
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            Log.SetLogToFile();
            Utils.SingleProgramTest(() => { MessageBox.Show("软件已经运行。"); }, "QUpdateGame");
        ...
        private void App_DispatcherUnhandledException(object sender, DispatcherUnhandledExceptionEventArgs e)
        {
            ...
            Log.Error("[QHorseGame] DispatcherUnhandledException error:" + e.Exception.ToString());
        ...
        private void App_UnhandledException(object sender, UnhandledExceptionEventArgs e)
        {
            ...
            Log.Error("[QHorseGame] UnhandledException:" + e.ExceptionObject.ToString());
