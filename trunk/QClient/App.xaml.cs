...
namespace QClientNS
{
    ...
    public partial class App : Application
    {
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            Utils.SingleProgramTest(() => { MessageBox.Show("软件已经运行。");}, "QClient");
        }
        ...
        private void App_DispatcherUnhandledException(object sender, DispatcherUnhandledExceptionEventArgs e)
        {
            ...
            Log.Error("[QClient] DispatcherUnhandledException error:" + e.Exception.ToString());
        ...
        {            
            ...
            Log.Error("[QClient] UnhandledException:" + e.ExceptionObject.ToString());
